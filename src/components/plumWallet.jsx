              ...
              <div className="flex flex-col gap-0 w-fit">
                ...
                <div className="w-full flex justify-center items-center">
                  <div className="flex flex-col items-center mt-6">
                    <h1
                      className="font-medium flex felx-row items-center align-center"
                      style={{
                        fontSize: "16px",
                        color: "#182230",
                        lineHeight: "21px",
                    ...
                    >
                      I'm still working on writing a case study for this project
                      :){" "}
                    </h1>
                    <h2
                      className="font-reguLAR flex felx-row items-center align-center pt-2"
                      style={{
                        fontSize: "14px",
                        color: "#182230",
                        lineHeight: "21px",
                    ...
                    >
                      I can still walk youthrough my Figma file
                    </h2>
                  </div>
                </div>
