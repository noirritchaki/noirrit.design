        ...
        <div className="flex flex-col justify-start max-w-2xl px-8 py-36">
          ...
          {!song ? (
            ...
            <div className="flex flex-col items-center">
              ...
              {/* Card */}
              <div className="relative bg-white rounded-[16px] p-6 shadow-md w-full max-w-sm mx-auto overflow-hidden text-center aspect-[1/1.05]">
                {/* Rotating CD */}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[16px] font-semibold text-[#182230] mt-4 block hover:underline"
                >
                  {song.title}
                </a>
